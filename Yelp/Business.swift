...
//        }
        ...
        if location != nil {
            let coordinateArray = location!.objectForKey("coordinate") as! NSDictionary
            if coordinateArray.count > 0 {
                latitude = coordinateArray["latitude"] as! Double
                longitude = coordinateArray["longitude"] as! Double
            }
        }
